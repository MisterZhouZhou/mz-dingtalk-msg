...
class DingTalk {
  ...
  /**
   * text 类型消息
   * @param params IText { title: string, mdText: string, text: string }
   * @returns Promise
   */
  public text(params: IText) {
    return this._sendData(getTextMsgBody(params))
  }

  /**
   * link 消息类型
   * @param param ILinkMsg { title: string, text: string, msgUrl: string, picUrl: string }
   * @return Promise
   */
  public link(params: ILinkMsg) {
    return this._sendData(getLinkMsgBody(params))
  }

  /**
   * markdown 消息类型
   * @param param IMarkDown { title: string, mdText: string, msgUrl: string, picUrl: string }
   * @return Promise
   */
  ...
  /**
   * feedCard 消息类型
   * @param param IFeedCard { links: { title: string, msgUrl: string, picUrl: string }]
   * @return Promise
   */
  ...
  /**
   * aloneAction 消息类型
   * @param param IAloneAction { links: { title: string, mdText: string, btns: { title: string, url: string}, sort: 'vertical' | 'horizontal', hideAvatar: boolean }]
   * @return Promise
   */
  ...
  /**
   * aloneAction 消息类型
   * @param param IWholeAction { links: { title: string, mdText: string, singleTitle: string, singleUrl: string, hideAvatar: boolean }]
   * @return Promise
   */
